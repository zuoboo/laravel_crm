                                        ...
                                        <div class="flex flex-wrap -m-2">
                                            ...
                                            <div class="p-2 w-full">
                                                <div class="relative">
                                                    ...
                                                    <input type="number" id="postcode" @change="fetchAddress" name="postcode"
                                            ...
                                            <div class="p-2 w-full">
                                                <div class="relative">
                                                    ...
                                                    <input for="gender0" type="radio" id="gender0" name="gender"
                                                        v-model="form.gender" value="0" class="ml-4">
                                                    <label class="ml-2 mr-4">男性</label>
                                                    <input for="gender1" type="radio" id="gender1" name="gender"
                                                        v-model="form.gender" value="1" class="ml-4">
                                                    <label class="ml-2 mr-4">女性</label>
                                                    <input for="gender2" type="radio" id="gender2" name="gender"
                                                        v-model="form.gender" value="2" class="ml-4">
